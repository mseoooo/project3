package com.sboot.sijak.config;
...
import com.sboot.sijak.interceptor.JwtInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		.excludePathPatterns("/kaja/join", "/home", "/loginHaja2", "/","/css/**", "/js/**", "/image/**","/kaja/checkid","/kaja/memberJoin","/memberJoin","/kaja/checkid"); 
		// 로그인, 회원가입, 공개된 경로 제외
	}
